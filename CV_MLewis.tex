...
\onehalfspacing
  ...
  \hangindent=.7cm {\bf Lewis, M.} \& Frank, M. C. (under review). Linguistic niches emerge from pressures at multiple timescales.

   \hangindent=.7cmFrank, M. C.,  {\bf Lewis, M.}, \& MacDonald, K. (under review). A performance model for early word learning.
 ...
 \hangindent=.7cm {\bf Lewis, M.} \& Frank, M. C. (in press). Linguistic structure emerges through the interaction of memory constraints and communicative pressures. Commentary on M. Christiansen \& N. Chater, The Now-or-Never Bottleneck: A Fundamental Constraint on Language. {\it Behavioral and Brain Sciences}.
  ...
  \hangindent=.7cm {\bf Lewis, M.} \& Frank M. C. (2016). Learnability Pressures Influence the Encoding Of Information Density In The Lexicon. In S.G. Roberts, C. Cuskley, L. McCrohon, L. Barcelo-Coblijn, O. Feher \& T. Verhoef (eds.) The Evolution of Language: Proceedings of the 11th International Conference (EVOLANG11).
